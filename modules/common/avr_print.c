...
// set MISO (PB4) output, all others input
// clear SS (PB2), MOSI (PB3), SCK (PB5)
#elif   defined (__AVR_ATmega168__) || defined( __AVR_ATmega328__) || \
        defined (__AVR_ATtiny88__) || defined (__AVR_ATtiny88A__) || \
	defined (__AVR_ATtiny28__) || defined (__AVR_ATtiny28A__) || \
	defined (__AVR_ATtiny44__) || defined (__AVR_ATtiny44A__)
#define SPI_DDR_SET {DDRB&=0xD3;DDRB|=0x10;} // clear PB2 (SS), PB3 (MOSI), PB5 (SCK), set PB4(MISO)
#define SPI_MEGA
